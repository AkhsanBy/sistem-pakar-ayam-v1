<?php
	...
	if (isset($_POST['submit'])) {
		...
		//semua aman
			...
			$login = login($pakar['email'], $pakar['password']);
		...
		<div class="col-md-4">
			...
			<div class="panel-group">
				<div class="panel panel-primary">
					<div class="panel-heading text-center"><strong>FORM LOGIN PAKAR</strong></div>
					<div class="panel-body">
						<form action="" method="post">
							<div class="form-group">
								<label for="email">Alamat Email</label>
								<input type="text" maxlength="100" id="email" class="form-control" name="pakar[email]" placeholder="Alamat Email">
							</div>
							<div class="form-group">
								<label for="password">Password</label>
								<input type="password" maxlength="100" id="password" class="form-control" name="pakar[password]" placeholder="Password">
							</div>
